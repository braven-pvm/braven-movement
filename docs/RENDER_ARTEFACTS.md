...
| 4, the finger clip | a clip at full speed, then slowed | **NO** | eight clips exist and none is usable | none |
...
Fifteen clips exist unarchived at `repo-onboarding-890149/out/coach-movies/` and
elsewhere in that worktree. They fail three ways at once:
